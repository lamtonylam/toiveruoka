...
describe('Backend API search helper', () => {
  ...
  it('finds matching foods for today in selected restaurants using backend format', async () => {
    ...
    const mockFetcher = async (
      ...
      if (food === 'kalapalat') {
        return {
          Exactum: [['Ma 15.09.', 'Rapeat kalapalat ja perunamuusi', 'kala, maito']],
          Kaivopiha: [['Ti 16.09.', 'Rapeat kalapalat', 'kala']],
        }
      }
      return {}
    }
    ...
    const mockFetcher = async (
      ...
      if (food === 'pizza') {
        return {
          ...
          Kaivopiha: [['Ti 16.09.', 'Pizza Pepperoni', 'G, L']],
          Chemicum: [['To 18.09.', 'Pizza Quattro Formaggi', 'G, L']],
        }
      }
      return {}
    }
